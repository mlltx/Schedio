...
import { SEVERITY_LABEL, SEVERITY_VISUAL } from "@/components/glance/visuals";
    ...
    <div className="mx-auto w-full max-w-2xl px-4 py-8 sm:px-6 sm:py-12">
      ...
      <div className="mt-8">
        ...
        {job.recentRuns.length === 0 ? (
          <p className="text-sm text-zinc-500 dark:text-zinc-400">No runs recorded yet.</p>
        ) : (
